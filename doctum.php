...
return new Doctum($iterator, [
    'versions'             => $versions,
    'title'                => 'Jundayw MessagePackCodec Documentation',
    'language'             => 'en', // Could be 'fr'
    'build_dir'            => __DIR__ . '/build/docs/%version%',
    'cache_dir'            => __DIR__ . '/cache/docs/%version%',
    'source_dir'           => dirname($dir) . '/',
    'remote_repository'    => new GitHubRemoteRepository('jundayw/message-pack-codec', dirname($dir)),
    // 'footer_link'          => [
    //     'href'        => 'https://github.com/jundayw/message-pack-codec',
